...
export async function registerIpcHandlers(mainWindow: BrowserWindow | null): Promise<void> {
  ...
  ipcMain.handle(
    IpcChannels.PROVIDERS_UPDATE,
    async (_, id: string, updates: Partial<Provider>): Promise<Provider | null> => {
  ...
  ipcMain.handle(
    IpcChannels.PROVIDERS_CHECK_STATUS,
    async (_, providerId: string): Promise<ProviderCheckResult> => {
  ...
  ipcMain.handle(
    IpcChannels.PROVIDERS_CHECK_ALL_STATUS,
    async (): Promise<Record<string, ProviderCheckResult>> => {
  ...
  ipcMain.handle(
    IpcChannels.PROVIDERS_SYNC_MODELS,
    async (
      _,
      providerId: string,
    ): Promise<{
  ...
  ipcMain.handle(
    IpcChannels.PROVIDERS_UPDATE_MODELS,
    async (
      _,
      providerId: string,
    ): Promise<{
  ...
  ipcMain.handle(
    IpcChannels.PROVIDERS_ADD_CUSTOM_MODEL,
    async (_, providerId: string, model: { displayName: string; actualModelId: string }) => {
      try {
        return {
          success: true,
  ...
  ipcMain.handle(
    IpcChannels.PROVIDERS_REMOVE_MODEL,
    async (_, providerId: string, modelName: string) => {
      try {
        return {
          success: true,
  ...
  ipcMain.handle(
    ...
    async (_, includeCredentials?: boolean): Promise<Account[]> => {
      return AccountManager.getAll(includeCredentials)
    },
  )

  ipcMain.handle(
    IpcChannels.ACCOUNTS_GET_BY_ID,
    async (_, id: string, includeCredentials?: boolean): Promise<Account | null> => {
      return storeManager.getAccountById(id, includeCredentials) || null
    },
  )

  ipcMain.handle(
    IpcChannels.ACCOUNTS_GET_BY_PROVIDER,
    async (_, providerId: string): Promise<Account[]> => {
      return storeManager.getAccountsByProviderId(providerId)
    },
  )

  ipcMain.handle(
    IpcChannels.ACCOUNTS_ADD,
    async (
      _,
      data: {
        providerId: string
  ...
  ipcMain.handle(
    IpcChannels.ACCOUNTS_UPDATE,
    async (_, id: string, updates: Partial<Account>): Promise<Account | null> => {
  ...
  ipcMain.handle(
    ...
    async (_, providerId: string, credentials: Record<string, string>) => {
  ...
  ipcMain.handle(
    IpcChannels.ACCOUNTS_GET_CREDITS,
    async (
      _,
      accountId: string,
    ): Promise<{
  ...
  ipcMain.handle(
    IpcChannels.ACCOUNTS_CLEAR_CHATS,
  ...
  ipcMain.handle(
    IpcChannels.OAUTH_LOGIN_WITH_TOKEN,
    async (
      _,
      data: {
        providerId: string
  ...
  ipcMain.handle(
    IpcChannels.OAUTH_START_IN_APP_LOGIN,
    async (
      _,
      data: { providerId: string; providerType: ProviderVendor; timeout?: number },
    ): Promise<OAuthResult> => {
  ...
  ipcMain.handle(
    IpcChannels.OAUTH_VALIDATE_TOKEN,
    async (
      _,
      data: {
        providerId: string
      ...
      return await oauthManager.validateToken(
        data.providerId,
        data.providerType as ProviderType,
        data.credentials,
      )
  ...
  ipcMain.handle(
    IpcChannels.OAUTH_REFRESH_TOKEN,
    async (
      _,
      data: {
        providerId: string
  ...
  ipcMain.handle(
    IpcChannels.LOGS_GET_ACCOUNT_TREND,
    async (_, accountId: string, days?: number) => {
  ...
  ipcMain.handle(
    IpcChannels.LOGS_GET_BY_ID,
    async (_, id: string): Promise<LogEntry | undefined> => {
  ...
  ipcMain.handle(
    IpcChannels.PROMPTS_GET_BY_ID,
    async (_, id: string): Promise<SystemPrompt | undefined> => {
      return storeManager.getSystemPromptById(id)
    },
  )

  ipcMain.handle(
    IpcChannels.PROMPTS_ADD,
    async (
      _,
  ...
  ipcMain.handle(
    IpcChannels.PROMPTS_UPDATE,
    async (_, id: string, updates: Partial<SystemPrompt>): Promise<SystemPrompt | null> => {
  ...
  ipcMain.handle(
    IpcChannels.PROMPTS_GET_BY_TYPE,
    async (_, type: SystemPrompt['type']): Promise<SystemPrompt[]> => {
  ...
  ipcMain.handle(
    IpcChannels.SESSION_UPDATE_CONFIG,
    async (_, updates: Partial<SessionConfig>): Promise<SessionConfig> => {
  ...
  ipcMain.handle(
    IpcChannels.SESSION_GET_BY_ID,
    async (_, id: string): Promise<SessionRecord | undefined> => {
      return sessionManager.getSession(id)
    },
  )

  ipcMain.handle(
    IpcChannels.SESSION_GET_BY_ACCOUNT,
    async (_, accountId: string): Promise<SessionRecord[]> => {
      return sessionManager.getSessionsByAccount(accountId)
    },
  )

  ipcMain.handle(
    IpcChannels.SESSION_GET_BY_PROVIDER,
    async (_, providerId: string): Promise<SessionRecord[]> => {
  ...
  ipcMain.handle(
    IpcChannels.MANAGEMENT_API_UPDATE_CONFIG,
    async (_, updates: Partial<ManagementApiConfig>): Promise<ManagementApiConfig> => {
      const config = ConfigManager.get()
